...
# Optionally copy the u2net model from local directory if available
COPY --chown=bgremover:bgremover u2net.onnx* /home/bgremover/.u2net/u2net.onnx
# RUN curl -s https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Gull_portrait_ca_usa.jpg/1280px-Gull_portrait_ca_usa.jpg | rembg i > /dev/null

COPY --chown=1000:1000 src/. .
CMD exec gunicorn --bind :$PORT --workers 1 --threads 2 --timeout 0 server:app
EXPOSE 8080
